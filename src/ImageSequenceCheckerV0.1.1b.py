...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #self.lineEditAnomalySize.setText('500')
...
if __name__ == "__main__":
    ...
    #if cinfig file exists, load the settings
    #print current directory
    print(os.getcwd())
    #if os.path.exists(os.getcwd() + '/isc.ini'):
    ...
    else: #if config file does not exist, set default values
        ui.lineEditAnomalySize.setText('500')
