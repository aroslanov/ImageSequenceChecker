...
This program written snd tested under Python 3 environment. Also, requires PIL module, so please install it with `pip install Pillow` command in your terminal window if you're getting a missing module error.
